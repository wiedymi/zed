...
#[cfg(any(windows, target_env = "ohos"))]
...
cfg_if::cfg_if! {
    if #[cfg(any(windows, target_env = "ohos"))] {
...
pub struct ChildStdin(
    #[cfg(any(windows, target_env = "ohos"))] Unblock<std::process::ChildStdin>,
    #[cfg(all(unix, not(target_env = "ohos")))] Async<std::process::ChildStdin>,
);
...
pub struct ChildStdout(
    #[cfg(any(windows, target_env = "ohos"))] Unblock<std::process::ChildStdout>,
    #[cfg(all(unix, not(target_env = "ohos")))] Async<std::process::ChildStdout>,
);
...
pub struct ChildStderr(
    #[cfg(any(windows, target_env = "ohos"))] Unblock<std::process::ChildStderr>,
    #[cfg(all(unix, not(target_env = "ohos")))] Async<std::process::ChildStderr>,
);
