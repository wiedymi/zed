...
pub use platform::{
    ...
    dispatch_arkui_key_event, handle_memory_warning, handle_system_notification_response,
    on_arkui_frame, persistent_uri_for_path, set_lifecycle_phase, set_scale_factor,
